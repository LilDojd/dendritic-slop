...
Use Pi unless the user explicitly requests another supported agent kind. Run `herdr agent` to inspect installed kinds and options. Pass native agent arguments only after `--`:
